...
echo -e '\e[7mDone With Adding new PPAs According to Ubuntu Base.\e[0m'
sudo apt -y purge firefox* vim -y &> /dev/null
sudo apt autoremove -y &> /dev/null
echo -e ''
echo -e '\e[7mPurged FireFox & VIM also done APT autoremove for leftovers.\e[0m'
divertpkgs
echo -e ''
echo -e '\e[7mDiverted VLC & libdrm-amdgpu pkgs for smooth upgrade.\e[0m'
echo -e ''
sudo apt update &> /dev/null
sudo apt upgrade -y &> /dev/null
echo -e '\e[7mDone With the APT upgrades includes new PPAs.\e[0m'
echo -e ''
sudo apt install -f -y &> /dev/null
sudo apt autoremove -y &> /dev/null
echo -e '\e[7mDone With the APT autoremove if any FOUND.\e[0m'
...
rmdivertpkgs
echo -e ''
echo -e '\e[7mRemoved VLC & libdrm-amdgpu Diverts to properly function after upgrades.\e[0m'
echo -e ''
rawplasmoidscnv
echo -e '\e[7mExtracted Plasmoids from this Script for Smooth Installing.\e[0m'
echo -e ''
wgetpkgsNinst
echo -e '\e[7mDone With the All Downloads & Installing Debs & Plasmoids.\e[0m'
delpkgs
echo -e ''
echo -e '\e[7mRemoved DEB pkgs & Plasmoids leftovers.\e[0m'
delppas
echo -e ''
echo -e '\e[7mRemoved wget PPAs data leftovers.\e[0m'
